...
public final class Graph<V> implements Iterable<GraphNode<V>> {
  ...
  public final void printDot(final SafeWriter writer) {
    printDot(writer, this.defaultDotStyle);
  }

  public final void printDot(final SafeWriter writer, final DotStyle<V> dotStyle) {
  ...
  public final void printDotBody(final String nodePrefix, final SafeWriter writer,
